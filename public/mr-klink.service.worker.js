...
/** @type {string} */
const CACHE_VERSION = '1734368234|23657525554';
/** @type {string} */
const CACHE_PREFIX = 'dogde_the_creeps-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'mr-klink.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["mr-klink.html","mr-klink.js","mr-klink.offline.html","mr-klink.icon.png","mr-klink.apple-touch-icon.png","mr-klink.worker.js","mr-klink.audio.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHABLE_FILES = ["mr-klink.wasm","mr-klink.pck","mr-klink.side.wasm"];
